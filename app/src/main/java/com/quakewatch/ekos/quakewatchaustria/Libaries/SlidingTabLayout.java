package com.quakewatch.ekos.quakewatchaustria.Libaries;
/**
 * Created by pkogler on 22.10.2015.
 * Open Source Libary for using SlidingTabLayout
 */
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView.setTextColor(getResources().getColorStateList(R.color.fab_material_white));
