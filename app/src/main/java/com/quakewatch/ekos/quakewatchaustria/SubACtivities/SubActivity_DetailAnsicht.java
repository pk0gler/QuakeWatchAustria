...
public class SubActivity_DetailAnsicht extends AppCompatActivity implements Serializable {
    ...
    private void setUpView() {
        ...
        DetailStrings strings[] = new DetailStrings[]
                {
                        new DetailStrings(R.drawable.ic_pin_drop_black_24dp, "Region", bebenData.getRegion()),
                        new DetailStrings(R.drawable.ic_my_location_black_24dp, "Location", bebenData.lat + ", " + bebenData.lon),
                        new DetailStrings(R.drawable.ic_line_style_black_24dp, "Depth", "" + bebenData.getDepth()),
                        new DetailStrings(R.drawable.ic_fingerprint_black_24dp, "ID", "" + bebenData.getId()),
                        new DetailStrings(R.drawable.ic_location_city_black_24dp, "Nearby Cities", bebenData.placesString)
                };
        ...
        if ((mag >= 1) && (mag <= 2.49)) {
            ...
            if (this.butJetzt != null)
                butJetzt.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(colorCodes[16])));
            ...
            if (this.butJetzt != null)
                butJetzt.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(colorCodes[17])));
            if ((mag >= 4.0) && (mag <= 4.49)) {
            ...
            if (this.butJetzt != null)
                butJetzt.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(colorCodes[18])));
            ...
            if (this.butJetzt != null)
                butJetzt.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(colorCodes[19])));
            if ((mag >= 7.0) && (mag <= 7.99)) {
            ...
            if ((mag >= 8.0) && (mag <= 8.99)) {
                ...
                if (this.butJetzt != null)
                    butJetzt.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(colorCodes[20])));
